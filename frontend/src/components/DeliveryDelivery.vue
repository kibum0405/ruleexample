<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <List&lt;Chicken&gt; offline label="Chickens" v-model="value.chickens" :editMode="editMode" @change="change"/>
            <ChickenManager offline label="Chickens" v-model="value.chickens" :editMode="editMode" @change="change"/>
        </v-card-text>
